                    ...
                    {imageFileUpload && (
                        <CircularProgressbar
                            ...
                            styles={{
                                ...
                                path: { stroke: `rgba(62,152,199, ${imageFileUpload / 100})` },
                            }}
                        />
                    )}
                    <img
                        ...
                        alt="user"
                        className={`rounded-full w-full h-full object-cover border-8 border-[lightgray] ${imageFileUpload && imageFileUpload < 100 && "opacity-50"}`}
                    />
                </div>
